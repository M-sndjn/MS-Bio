  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen  pointer-events-none">
      <div className="absolute inset-0 flex">
        ...
        {/* COLUMN 1 */}
        <div className="relative w-[75%] sm:w-[48%] border-l border-red-500/0 overflow-hidden">
          <div
        ...
        <div className="relative w-[18%] hidden sm:block border-l sm:border-amber-400/0 border-white/0 overflow-hidden">
          ...
          />
                    <div
            className="absolute w-full h-[20vh] sm:min-h-[35vh] bg-white sm:bg-white -top-[69vh]"
            style={{
              transform: `translateY(${scroll * 0.7}px)`,
            }}
          />
